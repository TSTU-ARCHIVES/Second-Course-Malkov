...
namespace GraphsADT__L10to12_
{
    ...
    public abstract class Graph : IEnumerable<int>, ICloneable
    {
        ...
        /// </summary>
        private void DFS(int start, ref bool[] seen)
        {
            int curV = start;
        ...
        /// </summary>
        private void BFS(int start, ref bool[] seen)
        {
            int curV = start;
        ...
        /// </summary>
        private void TarjanDFS(int node, List<List<int>> result, ref bool[] seen,
        ...
        private int FindOddVertex()
        {
            ...
            throw new Exception("Нахождение эйлерового цикла невозможно!");
        }
