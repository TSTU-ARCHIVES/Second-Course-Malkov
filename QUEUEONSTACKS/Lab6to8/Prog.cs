        ...
        public static void HandleStack()
        {
            ...
            while(C!=6)
            {
                switch(C)
                {
                    ...
                    case 2:
                        while (!stack.IsEmpty())
                            Console.WriteLine(stack.PopElem().ToString());
                        break;
                    case 3:
                        stack.InsertElem(GetCorrectUserInput(int.MinValue, int.MaxValue));
                        break;
                    case 4:
                        if (!stack.IsEmpty())
                            Console.WriteLine(stack.PopElem());
                        else
                            Console.WriteLine("Стэк пуст");
                        break;
                    case 5:
                        if (!stack.IsEmpty())
                            Console.WriteLine(stack.GetCurrent());
                        else
                            Console.WriteLine("Стэк пуст");
                        break;
                }
        ...
        public static void HandleQueue()
        {
            ...
            while (C != 6)
            {
                switch (C)
                {
                    ...
                    case 2:
                        while (!queue.IsEmpty())
                            Console.WriteLine(queue.PopElem().ToString());
                        break;
                    case 3:
                        queue.InsertElem(GetCorrectUserInput(int.MinValue, int.MaxValue));
                        break;
                    case 4:
                        Console.WriteLine(queue.PopElem());
                        break;
                    case 5:
                ...
                switch (C)
                {
                    ...
                    case 2:
                        while (!priorityQueue.IsEmpty())
                            Console.WriteLine(priorityQueue.PopElem().ToString());
                        break;
                    case 3:
                        Console.WriteLine("Введите элемент и его приоритет");
                        priorityQueue.InsertElem(Console.ReadLine(),GetCorrectUserInput(int.MinValue, int.MaxValue));
                        break;
                    case 4:
                        Console.WriteLine(priorityQueue.PopElem());
                        break;
                    case 5:
